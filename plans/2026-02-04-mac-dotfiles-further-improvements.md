...
**修正対象ファイル**: `~/dotfiles/mac/zsh/.zshrc`
...
**修正対象ファイル**: `~/dotfiles/mac/git/.gitconfig`

| 行 | Before | After |
|----|--------|-------|
| 43 | `~/.ssh/allowed_signers` | `~/.ssh/allowed_signers` |
...
**修正対象ファイル**: `~/dotfiles/mac/hammerspoon/init.lua`
...
**修正対象ファイル**: `~/dotfiles/mac/zsh/.zshrc.alias`
...
**修正対象ファイル**: `~/dotfiles/mac/setup.sh`
...
**修正対象ファイル**: `~/dotfiles/mac/vim/.vimrc`
...
**修正対象ファイル**: `~/dotfiles/mac/zsh/.zshrc.plugins`
...
**修正対象ファイル**: `~/dotfiles/mac/zsh/.zshrc.path`

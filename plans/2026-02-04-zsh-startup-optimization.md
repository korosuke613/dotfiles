...
**ファイル**: `~/dotfiles/mac/zsh/.zshrc.autocomplete`
...
**ファイル**: `~/dotfiles/mac/zsh/.zshrc.gcp`
...
**ファイル**: `~/dotfiles/mac/zsh/.zshrc.alias`
...
1. `~/.zshrc`
2. `~/dotfiles/mac/zsh/.zshrc.autocomplete`
3. `~/dotfiles/mac/zsh/.zshrc.gcp`
4. `~/dotfiles/mac/zsh/.zshrc.alias`
...
# 10回計測
bash ~/dotfiles/.claude/skills/zsh-startup-analyzer/scripts/measure-startup.sh
